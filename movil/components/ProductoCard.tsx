...
const ProductoCard = ({_id, descripcion, precio_venta, stock, cod_fabrica, marca}: Props) => {
  return (
            ...
            <View className='flex-1 min-w-0'>
                ...
                <View>
                    ...
                    <View className='flex-row px-2 justify-between'>
                        ...
                        { marca && <Text className='inline-flex border-yellow-200 bg-yellow-50 text-yellow-800 rounded-full px-2.5 items-center text-xs font-medium'>{marca}</Text>}
                    </View>
                </View>
