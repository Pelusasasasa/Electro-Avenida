...
lista.addEventListener("click", (e) => {
  if (
    ...
    e.target.parentNode.parentNode.className === "agregar"
  ) {
    ...
    permiso === "0"
      ? ponerValoresInputs(idSeleccionado)
      : sweet.fire({ title: "No tiene permisos para interactuar" });
