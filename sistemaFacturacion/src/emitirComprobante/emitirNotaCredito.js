                ...
                if (producto.length === 0) {
                    ...
                    sweet.fire({
                        ...
                        if (isConfirmed && value !== "") {
                            ...
                            parseFloat(producto.precio_venta) === 0 && await sweet.fire({title:"Producto con precio en 0"});
    ...
    try {
        ...
        if (codigoC.value === "") {
            ...
            if (venta.precioFinal>37070 && (buscarCliente.value === "A CONSUMIDOR FINAL" || dnicuit.value === "00000000")) {
                ...
                let ventaRelacionada = (await axios.get(`${URL}ventas/factura/${venta.numeroAsociado}/${tipo}/${venta.condIva}`,configAxios)).data;
